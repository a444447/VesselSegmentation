...
if __name__ == '__main__':
    ...
    # 原图
    srcImg = cv2.imread('/Users/afourseven/GitSpace/VesselSegmentation/data/raw/data/DRIVE/train/images/22_train.tif', cv2.IMREAD_ANYDEPTH | cv2.IMREAD_ANYCOLOR)

    # 使用Pillow读取GIF图像
    pil_img = Image.open('/Users/afourseven/GitSpace/VesselSegmentation/data/raw/data/DRIVE/train/1st_manual/22_manual1.gif')

    # 将PIL图像转换为numpy数组
    img_np = np.array(pil_img)

    # 如果你想在OpenCV中进一步处理或显示图像，可以这样做
